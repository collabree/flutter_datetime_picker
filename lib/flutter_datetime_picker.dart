...
class _DatePickerRoute<T> extends PopupRoute<T> {
  _DatePickerRoute({
    ...
    BasePickerModel? pickerModel,
        ...
        this.theme = theme ?? DateTimeDatePickerTheme(),
  ...
  final DateTimeDatePickerTheme theme;
...
//    print('refreshScrollOffset ${widget.pickerModel.currentRightIndex()}');
  ...
  Widget _renderPickerView(DateTimeDatePickerTheme theme) {
  ...
  Widget _renderItemView(DateTimeDatePickerTheme theme) {
    return Container(
      color: theme.backgroundColor,
  ...
  // Title View
  Widget _renderTitleActionsView(DateTimeDatePickerTheme theme) {
